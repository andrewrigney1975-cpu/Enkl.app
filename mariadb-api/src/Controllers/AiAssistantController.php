...
/** Ported from php-api/src/Controllers/AiAssistantController.php. ProjectMemberMiddleware is applied
 * on the route group in routes.php (same shape as TasksController), not here. */
