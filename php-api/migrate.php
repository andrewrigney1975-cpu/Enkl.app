...
/**
 * `php migrate.php` — deploys/updates the schema on whatever standalone Postgres instance the
 ...
 * applied migrations are tracked and skipped (see src/Db/Migrator.php).
 */
...
echo "Connecting to " . (getenv('DB_HOST') ?: 'localhost') . ":" . (getenv('DB_PORT') ?: '5432') . "/" . (getenv('DB_NAME') ?: 'enkl') . "...\n";
