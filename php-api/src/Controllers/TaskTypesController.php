...
/** Ported from Controllers/TaskTypesController.cs. */
final class TaskTypesController extends BaseController
{
    private function service(): TaskTypeService
    {
        return new TaskTypeService(Database::connection());
    }
