...
/**
 * Ported from Controllers/AnnouncementsController.cs. Any authenticated user (no OrgAdmin/
 * ProjectMemberMiddleware) — reading "what's currently relevant to me" and acknowledging one you've
 * seen are things every signed-in user can do, not an admin-only action. See
